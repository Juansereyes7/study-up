...
},{"./template":36,"empty-element":3,"page":30}],36:[function(require,module,exports){
'use strict';
...
},{"./home":35,"./signin":41,"./signup":43,"page":30}],38:[function(require,module,exports){
'use strict';
...
module.exports = function pictureCard(pic) {
  ...
  function render(picture) {
    return yo(_templateObject, picture.liked ? 'liked' : '', picture.url, picture.user.username, picture.user.avatar, picture.user.username, rf.format(picture.createAT), like.bind(null, true), like.bind(null, false), picture.likes);
  }
  function like(liked) {
    pic.like = liked;
    pic.likes += liked ? 1 : -1;
...
},{"intl":25,"intl-relativeformat":19,"intl-relativeformat/dist/locale-data/en.js":17,"intl-relativeformat/dist/locale-data/es.js":18,"yo-yo":33}],41:[function(require,module,exports){
'use strict';
...
},{"./template":44,"empty-element":3,"page":30}],44:[function(require,module,exports){
'use strict';
