...
},{"./update-events.js":36,"bel":1,"morphdom":30}],36:[function(require,module,exports){
module.exports = [
...
},{"../layout":41,"../picture-card":42,"yo-yo":35}],39:[function(require,module,exports){
'use strict';
...
},{"./home":37,"./signin":43,"./signup":45,"page":32}],40:[function(require,module,exports){
'use strict';
...
module.exports = function pictureCard(pic) {
  ...
  function render(picture) {
    return yo(_templateObject, picture.liked ? 'liked' : '', picture.url, picture.user.username, picture.user.avatar, picture.user.username, translate.date.format(picture.createAT), like.bind(null, true), like.bind(null, false), translate.message('likes', { likes: picture.likes }));
  }
  function like(liked) {
    pic.like = liked;
    pic.likes += liked ? 1 : -1;
...
},{"../landing":40,"yo-yo":35}],45:[function(require,module,exports){
'use strict';
